...
//ArchivoSecuencialIndexado
class ArchivoSecuencialIndexado {

    Integer BloqueActual = 1;
    String Administrador = "";
    Integer MaxReorganizar = 2;
    ...
    private String ObtenerLinea(Integer n, String PathArchivo) throws IOException {
        String Linea;
        try (Stream<String> Lineas = Files.lines(Paths.get(PathArchivo))) {
            Linea = Lineas.skip(n - 1).findFirst().get();
        }
        return Linea;
    }
